...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('web_id', models.CharField(blank=True, help_text='format: required, unique', max_length=50, null=True, unique=True, verbose_name='product website ID')),
                ...
                ('updated_at', models.DateTimeField(help_text='format: Y-m-d H:M:S', verbose_name='date product last updated')),
